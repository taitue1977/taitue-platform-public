...
export default function FounderMoneyResetSalepage() {
  ...
  return (
    <article
      ...
      style={{
        background:
          "radial-gradient(circle at top left, rgba(212,168,67,0.06), transparent 60%), #0a0a0a",
    ...
    >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(212,168,67,0.12) 0%, rgba(251,191,36,0.04) 100%)",
      ...
      >
        ...
        <div className="relative">
          <p className="text-sm sm:text-base text-gray-300 max-w-xl mx-auto mb-5 leading-relaxed">
            Để cải thiện tình hình sức khỏe tài chính của anh/chị, Tài Tuệ Academy
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent, rgba(212,168,67,0.08))",
