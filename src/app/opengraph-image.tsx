    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 60%, #2a1a05 100%)",
          padding: "72px 88px",
          position: "relative",
        }}
      >
        ...
        >
          ...
          <div style={{ color: "#D4A843" }}>{siteConfig.tagline}</div>
        </div>
        ...
        >
          <div style={{ color: "#D4A843" }}>{siteConfig.domain}</div>
