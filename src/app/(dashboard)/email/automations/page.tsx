          ...
          <>
            ...
            {filtered.length > 0 && (
              <div
                ...
                style={{
                  background:
                    selectedIds.size > 0 ? "rgba(212,168,67,0.08)" : "#141414",
                  border:
                    selectedIds.size > 0
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-1">
                        <Link
                          ...
                          className="font-semibold text-white text-sm truncate hover:text-[#D4A843] transition-colors"
                        >
                          {a.name}
                        </Link>
                        <span
                  ...
                  templates.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={creating}
                        className="w-full text-left p-4 rounded-lg border border-[#2a2a2a] bg-[#0d0d0d] hover:border-[#D4A843] hover:bg-[#1a1a1a] transition-all disabled:opacity-50 disabled:cursor-wait"
                      >
