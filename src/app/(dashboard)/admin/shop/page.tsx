...
const TYPE_META: Record<string, { label: string; icon: typeof BookOpen; color: string; bg: string }> = {
  book: { label: "Sách giấy", icon: BookOpen, color: "#D4A843", bg: "rgba(212,168,67,0.12)" },
  ...
  return (
    <div>
      ...
      <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6">
        ...
        {/* Hint */}
        {totalCount > 0 && (
          <div className="p-4 rounded-lg text-xs text-gray-500 leading-relaxed" style={{ background: "rgba(212,168,67,0.06)", border: "1px solid rgba(212,168,67,0.15)" }}>
            ...
            <Link href="/shop" className="text-[#D4A843] hover:underline">/shop</Link>.
          </div>
        )}
      </div>
    </div>
