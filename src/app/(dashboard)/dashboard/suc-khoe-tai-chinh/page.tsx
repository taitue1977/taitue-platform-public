    ...
    <div>
      ...
      <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-5">
        ...
        >
          ...
          >
            <Activity size={22} className="text-[#D4A843]" />
          </div>
          ...
          <Link
            ...
            style={{ background: `linear-gradient(135deg, #D4A843, #FBBF24)` }}
          >
            <Plus size={14} />
        ...
        {rows.length === 0 && (
          <div className="card-dark p-12 text-center">
            ...
            >
              <Activity size={26} className="text-[#D4A843]" />
            </div>
          ...
          <div className="grid sm:grid-cols-[1fr_280px] gap-4">
            ...
            >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg text-sm font-medium text-[#D4A843] hover:text-white transition-colors"
