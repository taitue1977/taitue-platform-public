                  ...
                  {(
                    ...
                    return (
                      <label key={opt.value} className="cursor-pointer">
                        ...
                        />
                        <span
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border transition-colors peer-checked:border-[#D4A843] peer-checked:bg-[#D4A843]/15 peer-checked:text-[#D4A843] text-gray-400 hover:text-white"
                          style={{
                            background: "#141414",
                            borderColor: "#2a2a2a",
                          }}
          ...
          <div className="space-y-5">
            ...
            <details className="card-dark p-0">
              <summary className="p-5 cursor-pointer flex items-center gap-2 text-sm font-semibold text-white hover:bg-white/[0.02] transition-colors">
                <Edit size={14} className="text-[#D4A843]" />
