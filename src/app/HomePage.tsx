...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Sau 3 tháng theo lộ trình của Tài Tuệ, tôi tách bạch hoàn toàn tiền cá nhân và công ty, tự trả lương đều đặn. Áp lực gia đình giảm rõ rệt.",
  ...
  },
  {
    ...
    quote:
      "Tài Tuệ giúp tôi xây quỹ dự phòng riêng cho gia đình trước khi dồn tiền vào round gọi vốn tiếp theo. Giờ tôi pitch nhà đầu tư trong tâm thế bình an.",
  ...
  },
  {
    ...
    quote:
      "Tôi đã ngừng vay thẻ tín dụng để nuôi DN. Tài Tuệ giúp tôi nhìn rõ điểm gãy và xây quỹ khẩn cấp riêng. Quyết định kinh doanh sáng suốt hơn hẳn.",
        ...
        <div className="mt-10 max-w-3xl mx-auto">
          <div className="relative aspect-video rounded-xl overflow-hidden border border-[#2a2a2a] bg-black">
            <iframe
              ...
              title="Video giới thiệu Tài Tuệ Academy"
    ...
    return (
      <div className="mt-10 max-w-3xl mx-auto">
        <button
          ...
          aria-label="Phát video giới thiệu Tài Tuệ Academy"
        ...
        >
          <Image
            ...
            alt="Video giới thiệu Tài Tuệ Academy"
            fill
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div
              ...
              style={{ background: "#D4A843", boxShadow: "0 10px 40px rgba(212,168,67,0.5)" }}
            >
  ...
  return (
    <div className="mt-10 max-w-3xl mx-auto">
      ...
      >
        ...
        >
          <PlayCircle size={36} style={{ color: "#D4A843" }} />
        </div>
        <div className="text-center px-4">
          <p className="text-white font-semibold text-base sm:text-lg">Video giới thiệu Tài Tuệ Academy</p>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: siteConfig.colors.background }}>
            ...
            {MISTAKES.map((m) => (
              ...
              >
                <div className="flex items-start gap-3 mb-3">
                  <div className="text-3xl shrink-0" style={{ filter: "drop-shadow(0 0 6px rgba(212,168,67,0.25))" }}>
                    {m.icon}
                  </div>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{ background: "rgba(212,168,67,0.12)", color: brand }}
                  >
                    <Icon size={20} />
                  </div>
      ...
      {/* About NCS Nguyễn Tài Tuệ */}
      <section className="py-16 px-4 sm:px-6 border-t border-[#1a1a1a]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-4xl font-extrabold text-center mb-12">
            Nguyễn Tài Tuệ <span style={{ color: brand }}>Là Ai?</span>
          </h2>
          ...
          <div className="grid md:grid-cols-[minmax(0,360px)_1fr] gap-8 lg:gap-12 items-start">
            ...
            <div className="mx-auto md:mx-0 w-full max-w-[340px]">
              ...
              >
                <div className="rounded-xl overflow-hidden aspect-[3/4] relative" style={{ background: "#0a0a0a" }}>
                  {/* TODO: thay siteConfig.owner.avatar thành ảnh chân dung NCS Nguyễn Tài Tuệ khi có */}
                  <Image
                    src={siteConfig.owner.avatar}
                    alt="NCS Nguyễn Tài Tuệ"
                    fill
              ...
              <div className="text-center mt-4">
                <p className="font-bold text-white text-lg">Nguyễn Tài Tuệ</p>
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6 text-sm sm:text-base">
                Tôi là <span className="text-white font-medium">Nguyễn Tài Tuệ</span> — nhà đào tạo, cố vấn và diễn giả
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-base text-gray-400 max-w-2xl mx-auto leading-relaxed">
              ...
              Hà Nội 2025 — Ths. Nguyễn Tài Tuệ đã trực tiếp đào tạo và đồng
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            ...
            {[
              ...
              },
              {
                ...
                alt: "Ths. Nguyễn Tài Tuệ — Chuyên gia Khởi Nghiệp Quốc Gia, Tổng Thư Ký Hội đồng Tư vấn Khởi Nghiệp Quốc Gia (viNen)",
                badge: "Credential",
                contain: true,
                bg: "#b8000d",
              },
      ...
      <section className="py-16 px-4 sm:px-6 border-t border-[#1a1a1a]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <Gift size={14} />
            Tặng miễn phí từ NCS Nguyễn Tài Tuệ
          </div>
