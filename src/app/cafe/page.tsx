...
export const metadata: Metadata = {
  ...
  description:
    "Mỗi ly cafe 99K, đội ngũ Tài Tuệ Academy gửi tặng bạn tài liệu 100 mô hình kinh doanh sản phẩm số doanh thu 1 triệu đô la trên thế giới, ứng dụng cho Việt Nam.",
  alternates: {
