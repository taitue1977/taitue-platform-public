...
const CATEGORY_META: Record<string, { label: string; icon: typeof BookOpen; color: string }> = {
  sach: { label: "Sách", icon: BookOpen, color: "#D4A843" },
                        ...
                        >
                          ...
                          <div className="flex-1 flex flex-col p-4">
                            <Link href={`/shop/${p.slug}`} className="block mb-3">
                              <h3 className="font-semibold text-white text-sm leading-snug line-clamp-2 min-h-[2.5rem] hover:text-[#D4A843] transition-colors text-center">
                                {p.title}
                              </h3>
                            </Link>
                            ...
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <BuyProductButton
                                ...
                                className="ml-auto inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold border border-[#2a2a2a] text-white hover:border-[#D4A843] hover:text-[#D4A843] transition-colors whitespace-nowrap"
