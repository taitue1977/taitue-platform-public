...
const TYPE_META: Record<string, { label: string; icon: typeof BookOpen; color: string }> = {
  book: { label: "Sách giấy", icon: BookOpen, color: "#D4A843" },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        >
          ...
          <BuyProductButton
            ...
            isAuthenticated={!!user}
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl text-base font-bold text-black transition-transform hover:scale-[1.02] active:scale-[0.99] whitespace-nowrap shrink-0 bg-[#D4A843] hover:bg-[#FBBF24]"
