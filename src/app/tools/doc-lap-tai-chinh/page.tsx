...
export const metadata: Metadata = {
  ...
  description:
    "Công cụ tính cấp độ Độc Lập Tài Chính theo NCS Tài Tuệ — thu nhập thụ động ≥ chi tối thiểu, hoặc TS sinh dòng tiền × 4% ≥ chi năm.",
  alternates: { canonical: `${BASE_URL}/tools/doc-lap-tai-chinh` },
  openGraph: {
    title: "Độc Lập Tài Chính — Tài Tuệ Academy",
    description:
