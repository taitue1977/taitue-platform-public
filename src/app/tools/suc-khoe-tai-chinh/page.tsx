...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Đo lường 11 chỉ số sức khoẻ tài chính theo 5 nhóm & nhận lời khuyên cá nhân hoá từ Tài Tuệ Academy.",
    type: "website",
    locale: "vi_VN",
      ...
      <section className="px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold leading-tight mb-4">
            Kiểm Tra Sức Khoẻ
            <br />
            <span style={{ color: "#D4A843" }}>Tài Chính Cá Nhân</span>
          </h1>
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-2 sm:grid-cols-5 gap-2 mb-8">
          {[
            ...
            >
              <f.icon size={13} className="text-[#D4A843] shrink-0" />
