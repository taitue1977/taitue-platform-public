...
export const metadata: Metadata = {
  ...
  description:
    "Công cụ tính cấp độ An Toàn Tài Chính theo NCS Tài Tuệ — tài sản thanh khoản ≥ 120 tháng thu nhập + có bảo hiểm đầy đủ.",
  alternates: { canonical: `${BASE_URL}/tools/an-toan-tai-chinh` },
  openGraph: {
    title: "An Toàn Tài Chính — Tài Tuệ Academy",
    description:
