    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
          Theo định nghĩa của thầy Tài Tuệ: <strong className="text-white">
        ...
        <div className="space-y-3">
          ...
          <Section icon={Shield} label="Mệnh giá bảo hiểm hiện có" color={RED}>
            ...
            <Link
              ...
              className="block text-center mt-1.5 text-[10px] text-[#D4A843] hover:underline"
            >
    ...
    >
      ...
      >
        {both
          ...
          : "Cần đạt ĐỦ CẢ HAI điều kiện để được công nhận An Toàn TC theo framework của thầy Tài Tuệ."}
      </p>
    </div>
  );
}
