      ...
      >
        <div className="max-w-[900px] mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <button
            ...
            style={{
              background: `linear-gradient(135deg, #FBBF24, ${BRAND})`,
              color: "#0a0a0a",
      ...
      <div className="max-w-[900px] mx-auto py-8 print:py-0">
        ...
        >
          ...
          >
            ...
            <strong className="text-white print:text-black">Tài Tuệ Academy</strong>
...
function BigProCTA() {
  return (
    <div
      ...
      style={{
        background: `linear-gradient(135deg, #FBBF2410, #D4A84320, #a855f710)`,
        border: `2px solid #D4A84377`,
        boxShadow: `0 12px 36px #D4A84333`,
      }}
    >
      <div className="grid sm:grid-cols-[1fr_auto] gap-4 items-center">
        <div>
          ...
          <p className="text-[12.5px] text-gray-300 leading-relaxed print:text-gray-800">
            ...
            với coaching 1-1 cùng NCS Tài Tuệ.
          </p>
        ...
        <Link
          ...
          style={{
            ...
            color: "#0a0a0a",
            boxShadow: `0 10px 30px #D4A84366`,
          }}
        >
          Nâng cấp ngay
          <Crown size={16} />
